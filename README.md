...
-   Modelo de IA recomendado: `gemma3:4b` (o el que prefieras configurar).
...
-   Ingresa el nombre de tu modelo local (ej: `gemma3:4b`, `llama3.2:3b`, `mistral:7b`) en el campo de configuración.
